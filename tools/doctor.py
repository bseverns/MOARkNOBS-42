    ...
    if selected_firmware:
        guard_commands.extend(
            [
                ...
                (
                    "native button interpreter compile",
                    [
                        "c++",
                        "-std=c++17",
                        "-Wall",
                        ...
                        "-I",
                        "firmware/include",
                        "firmware/src/ButtonGestureInterpreter.cpp",
                        "tools/button_gesture_interpreter_test.cpp",
                        "-o",
                        "/tmp/mn42-button-interpreter",
                    ],
                ),
                ("native button interpreter tests", ["/tmp/mn42-button-interpreter"]),
