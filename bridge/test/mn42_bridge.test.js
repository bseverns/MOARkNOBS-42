...
assert.match(result.stdout, /--osc/, 'help text should advertise the osc flag');
assert.match(result.stdout, /--bind/, 'help text should advertise the bind flag');
assert.match(result.stdout, /--midi/, 'help text should advertise the midi flag');
