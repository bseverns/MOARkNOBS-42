...
Miss a few scheduler slots? No sweat—the next `update()` call looks at how many ticks piled up and burns through every overdue step so the riff never drifts late.
