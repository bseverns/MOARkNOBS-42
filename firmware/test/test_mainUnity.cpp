...
void setup() {
    ...
    RUN_TEST(test_ui_context_help_uses_registry_generated_copy);
    ...
    RUN_TEST(test_profile_v2_migration_preserves_follower_and_expands_routes);
    RUN_TEST(test_profile_v3_migration_preserves_expanded_route_and_legacy_slot);
    RUN_TEST(test_profile_v4_migration_preserves_slots_and_defaults_new_runtime_fields);
    ...
    RUN_TEST(test_profile_load_retains_current_config_when_both_copies_are_corrupt);
    ...
    RUN_TEST(test_dispatch_get_argmethod_uses_direct_handler);
    RUN_TEST(test_dispatch_preserves_legacy_config_command_lane);
    ...
    RUN_TEST(test_config_bulk_parse_failure_discards_partial_transaction);
    RUN_TEST(test_config_bulk_missing_identity_discards_complete_transaction);
    RUN_TEST(test_config_bulk_abort_is_idempotent);
    RUN_TEST(test_config_bulk_timeout_resets_upload_and_reports_sequence);
    RUN_TEST(test_config_bulk_duplicate_retry_replays_stable_ack_without_apply);
    ...
    RUN_TEST(test_midi_input_router_matches_port_channel_and_controller);
    ...
    RUN_TEST(test_schema6_relocation_failure_does_not_promote_config_version);
