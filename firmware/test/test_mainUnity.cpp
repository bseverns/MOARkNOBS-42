...
void setup() {
    ...
    RUN_TEST(test_dispatch_set_arp_persists_active_profile_snapshot);
    RUN_TEST(test_dispatch_set_profile_arp_pattern_length_applies_and_persists);
    RUN_TEST(test_dispatch_set_clock_persists_active_profile_snapshot);
    RUN_TEST(test_dispatch_set_jitter_persists_active_profile_snapshot);
    RUN_TEST(test_dispatch_set_note_dynamics_persists_active_profile_snapshot);
