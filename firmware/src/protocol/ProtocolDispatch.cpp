...
const CommandHandler kCommandHandlers[] = {
    ...
    {"GET_ARP", ProtocolDispatchHandlers::handleGetArpCommand},
    ...
    {"GET_CONFIG_CHUNKED", ProtocolDispatchHandlers::handleGetConfigChunkedCommand},
    ...
    {"GET_MOD_MATRIX_CHUNKED", ProtocolDispatchHandlers::handleGetModMatrixChunkedCommand},
    ...
    {"SET_ARP", ProtocolDispatchHandlers::handleSetArpCommand},
