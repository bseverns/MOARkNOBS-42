...
| `hardware/`          | Current hardware reference PDFs, parts notes, fabrication boundary note, current-build notes           | Reference and hardware-test evidence. No orderable fabrication package is tracked in `hardware/fabrication/`.                                 |
