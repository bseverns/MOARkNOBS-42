...
![Console-style handshake diagram showing the browser HELLO request and the firmware JSON response.](webserial_handshake.svg)
...
![Screenshot of the browser configurator showing live slot controls, staged edits, and telemetry cards.](profiles-ui.png)
