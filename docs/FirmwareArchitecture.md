...
- [Testing](TESTING.md) for what the current automated suite proves
- [WebSerial Protocol](WebSerial.md) for the contract the firmware exposes to hosts
- [Assumption Ledger](assumption-ledger.md) for what is confirmed in source versus what still needs bench receipts
- [History](HISTORY.md) for how the architecture got this way
