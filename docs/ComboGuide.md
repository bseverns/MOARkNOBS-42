...
- [Failure-First Guide](FailureFirst.md) for what to do when a combo puts the rig somewhere unexpected
- [Builder's Handbook](BuildersHandbook.md) for the broader hands-on control story
