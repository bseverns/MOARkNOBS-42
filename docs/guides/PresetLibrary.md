...
- [Musician-First Guide](../getting-started/MusicianFirstGuide.md) for a rehearsal-first path through presets and profiles
...
- [Demo Polish](../validation/DemoPolish.md) for how the demo profiles are used in presentation and soak testing
