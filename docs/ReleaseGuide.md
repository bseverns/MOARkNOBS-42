...
2. **Refresh the human-facing release notes** – update [CHANGELOG.md](https://github.com/bseverns/benzknober/blob/main/CHANGELOG.md) and the relevant entry in [HISTORY.md](HISTORY.md) so both the terse delta log and the longer narrative are current.
