...
| Runtime orchestration                                                                         | Covered                  | Unity                                   | Pending note-offs, diagnostic counter reporting, and related runtime state transitions are asserted directly. A 42-slot modulation burst proves that aggregate admission spreads output across frames, and a sustained 42-Note stress case verifies that the governed rate preserves release-queue capacity.                         |
