...
| BOM export | none present in audited tree | `experimental` | `TODO: add a versioned BOM export under hardware/.` |
...
- [Repo Health Audit 2026-03](repo-health-audit-2026-03.md)
