...
| I am operating the browser console      | [Bridge Console Tour](BridgeConsoleTour.md)                                                                                        | Explains Setup, Routing, Monitor, Diagnostics, snapshots, and recovery actions. |
...
| Browser console role split      | [Bridge Console Tour](BridgeConsoleTour.md)                                                                                                  | Implemented as Setup, Routing, Monitor, and Diagnostics operator modes.                                                                  |
| Artifact hardening              | [bridge README](https://github.com/bseverns/MOARkNOBS-42/blob/main/bridge/README.md), [Bridge Signing Plan](../release/BridgeSigningPlan.md) | Unsigned CI artifacts now include checksums, README, license payload, manifest metadata, and smoke checks. Signing remains future work. |
