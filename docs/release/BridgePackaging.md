...
- Bridge bundles remain workflow artifacts until every core and platform package lane succeeds. The final publication job then creates or updates the GitHub prerelease and uploads the complete labeled asset set.
