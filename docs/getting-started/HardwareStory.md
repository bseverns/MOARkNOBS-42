...
Use [Troubleshooting](../validation/Troubleshooting.md) and the bench figures there when you suspect brownout or rail sag.
...
- [Troubleshooting](../validation/Troubleshooting.md) for failure-first diagnostics
- [Pin Map](../reference/PinMap.md) for exact hardware assignments
- [EEPROM Layout](../reference/EEPROMLayout.md) for how physical state becomes persistent state
