...
- [Combo Guide](../guides/ComboGuide.md)
- [Failure-First Guide](../validation/FailureFirst.md)
...
1. [Preset Library](../guides/PresetLibrary.md)
2. [Profile Workflow](../guides/ProfileWorkflow.md)
3. [Combo Guide](../guides/ComboGuide.md)
4. [Bridge for Performers](../guides/BridgeForPerformers.md)
...
- [Preset Library](../guides/PresetLibrary.md) for choosing a starting sound/mapping idea
- [Profile Workflow](../guides/ProfileWorkflow.md) for turning that idea into saved device memory
- [Bridge for Performers](../guides/BridgeForPerformers.md) for host/DAW workflows
- [Failure-First Guide](../validation/FailureFirst.md) for recovery habits
