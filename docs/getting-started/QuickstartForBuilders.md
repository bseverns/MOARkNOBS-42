...
Before ordering boards or parts, read [Hardware Current Build](../reference/HardwareCurrentBuild.md).
...
- Start with [Troubleshooting](../validation/Troubleshooting.md).
- Use [Builder's Handbook](BuildersHandbook.md) for wiring and bring-up context.
- Use [Hardware Substitutions](../reference/HardwareSubstitutions.md) before swapping parts on instinct.
- Use [Validation Flow](../validation/ValidationFlow.md) to decide whether the board is still in bring-up, ready for demo work, or blocked on bench fixes.
